...
<form action="{{ route('employees.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3 mt-3">
        ...
        value="{{ old('first_name') }}" placeholder="Enter first_name" name="first_name">
    </div>

    <div class="mb-3 mt-3">
        <label for="last_name" class="form-label">Last_name:</label>
        <input type="text" class="form-control" id="name"
        value="{{ old('last_name') }}" placeholder="Enter last_name" name="last_name">
    </div>
    ...
    <div class="mb-3 mt-3">
        ...
        value="{{ old('date_of_birth') }}" placeholder="Date_of_birth" name="date_of_birth">
    </div>

    <div class="mb-3 mt-3">
        <label for="hire_date" class="form-label">hire_date:</label>
        <input type="date" class="form-control" id="hire_date"
        value="{{ old('hire_date') }}" placeholder="Hire_date" name="date_of_birth">
    </div>

    <div class="mb-3 mt-3">
        <label for="salary" class="form-label">Salary:</label>
        <input type="number" class="form-control" id="salary"
        value="{{ old('salary') }}" placeholder="Salary" name="salary">
    </div>

    <div class="mb-3 mt-3">
        <label for="is_active" class="form-label">Is_active:</label>
        <input type="number" class="form-control" id="is_active"
        value="{{ old('is_active') }}" placeholder="is_active" name="is_active">
    </div>

    <div class="mb-3 mt-3">
        <label for="department_id" class="form-label">Department_id:</label>
        <input type="number" class="form-control" id="department_id"
        value="{{ old('department_id') }}" placeholder="department_id" name="department_id">
    </div>

    <div class="mb-3 mt-3">
        <label for="manager_id" class="form-label">Manager_id:</label>
        <input type="number" class="form-control" id="manager_id"
        value="{{ old('manager_id') }}" placeholder="manager_id" name="manager_id">
    </div>
    ...
    <div class="mb-3 mt-3">
        ...
        value="{{ old('profile_picture') }}" placeholder="profile_picture" name="profile_picture">
    </div>
